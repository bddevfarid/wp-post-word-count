...
if ( ! class_exists( 'WP_Post_Word_Count_Plugin' ) ) {
	class WP_Post_Word_Count_Plugin {
		...
		public function wp_post_word_count_load_textdomain() {
			load_plugin_textdomain( 'wp-post-word-count', false, __DIR__ . '/languages' );
		}
	...
	add_action( 'plugins_loaded', array( $obj, 'wp_post_word_count_load_textdomain' ) );
	add_filter( 'manage_posts_columns', array( $obj, 'wp_post_word_count_words_text' ), 10, 1 );
	add_action( 'manage_posts_custom_column', array( $obj, 'wp_post_word_count' ), 10, 2 );
	add_action( 'admin_enqueue_scripts', array( $obj, 'wp_post_word_count_css' ) );
	add_filter( 'manage_posts_columns', array( $obj, 'wp_post_word_count_thumbnail_image_column_text' ), 10, 1 );
	add_action( 'manage_posts_custom_column', array( $obj, 'wp_post_word_count_thumbnail_image_column' ), 10, 2 );
	add_filter( 'the_content', array( $obj, 'wp_post_word_count_the_content' ) );
	add_filter( 'the_content', array( $obj, 'wp_post_word_count_the_content_reading_time' ) );
	add_filter( 'the_content', array( $obj, 'wp_post_word_count_the_content_human_time_diff' ) );
	add_filter( 'the_content', array( $obj, 'wp_post_word_count_the_content_author' ) );
	add_filter( 'the_content', array( $obj, 'wp_post_word_count_the_content_categories' ) );
	add_filter( 'the_content', array( $obj, 'wp_post_word_count_the_content_tags' ) );
	add_filter( 'the_content', array( $obj, 'wp_post_word_count_the_content_total_comments' ) );
